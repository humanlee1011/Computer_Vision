...
class Triangle
{
	public:
		...
		Triangle(const VertexType &_p1, const VertexType &_p2, const VertexType &_p3, int _i, int _j, int _k)
		:	p1(_p1), p2(_p2), p3(_p3),
			e1(_p1, _p2), e2(_p2, _p3), e3(_p3, _p1), isBad(false)
		{
		...
		bool containsVertex(const VertexType &v) const
		{
			...
			return almost_equal_v(p1, v) || almost_equal_v(p2, v) || almost_equal_v(p3, v);
		}
		...
		bool equal(const Triangle<T> &t1) {
			return ((t1.i == this->i) && t1.j == this->j && t1.k == this->k && t1.i != -1 && t1.j != -1 && t1.k != -1);
		}
...
template <class T>
inline bool almost_equal_t(const Triangle<T> &t1, const Triangle<T> &t2)
{
	return	(almost_equal_v(t1.p1 , t2.p1) || almost_equal_v(t1.p1 , t2.p2) || almost_equal_v(t1.p1 , t2.p3)) &&
			(almost_equal_v(t1.p2 , t2.p1) || almost_equal_v(t1.p2 , t2.p2) || almost_equal_v(t1.p2 , t2.p3)) &&
			(almost_equal_v(t1.p3 , t2.p1) || almost_equal_v(t1.p3 , t2.p2) || almost_equal_v(t1.p3 , t2.p3));
}
