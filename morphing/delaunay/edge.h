...
template <class T>
inline bool almost_equal_e(const Edge<T> & e1, const Edge<T> & e2)
{
	return	(almost_equal_v(e1.p1, e2.p1) && almost_equal_v(e1.p2, e2.p2)) ||
			(almost_equal_v(e1.p1, e2.p2) && almost_equal_v(e1.p2, e2.p1));
}
